...
# =============================================================================
# LOAD PROCESSED ICPSR DATA FROM GITHUB
# =============================================================================
# These files are pre-processed county-level aggregates from ICPSR datasets
# They live in data/processed/ and are committed to the GitHub repository

cat("\nLoading processed ICPSR datasets from GitHub...\n")

# GitHub base URL for processed data
github_base <- "https://raw.githubusercontent.com/eliza11494-hub/Thesis/main/data/processed"

# Load Nanda Turnout Data (2016 onwards)
nanda_url <- paste0(github_base, "/nanda_turnout_2016_onwards.csv")
nanda_2016_on <- read_csv(nanda_url, show_col_types = FALSE)
# Ensure Fips is character for merging
nanda_2016_on$Fips <- as.character(nanda_2016_on$Fips)
cat("✓ Loaded Nanda turnout data (2016+)\n")

# Load Urbanicity Data
urbanicity_url <- paste0(github_base, "/urbanicity_data.csv")
Urbancity_Data <- read_csv(urbanicity_url, show_col_types = FALSE)
cat("✓ Loaded urbanicity data\n")

# Load Street Connectivity Data 2010
connectivity_2010_url <- paste0(github_base, "/county_connectivity_2010.csv")
county_connectivity_averages_2010 <- read_csv(connectivity_2010_url, show_col_types = FALSE)
cat("✓ Loaded 2010 street connectivity data\n")

# Load Street Connectivity Data 2020
connectivity_2020_url <- paste0(github_base, "/county_connectivity_2020.csv")
county_connectivity_averages_2020 <- read_csv(connectivity_2020_url, show_col_types = FALSE)
